...
// Add a new icon for Form Configuration Tool
const FormInputIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-form-input">
...
function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { id: "config-tool", label: "Form Config Tool", icon: <FormInputIcon /> },
